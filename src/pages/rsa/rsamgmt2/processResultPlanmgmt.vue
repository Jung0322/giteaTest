<!--
  목적 : 위험성평가 > 작업 위험성평가 (HE) >  공정위험성평가 관리 (Upload) > 평가결과 관리
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // Url Setting
      this.searchUrl = selectConfig.rsa.resultmgmt2.list.url;
      ...
      this.searchParam.riskTypeCd = 'RWRS2';
