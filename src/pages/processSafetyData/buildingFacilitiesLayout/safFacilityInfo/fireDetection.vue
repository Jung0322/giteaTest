...
export default {
  ...
  methods: {
    init() {
      this.tabItems = [
        {
          title: this.$comm.getLangSpecInfoLabel('L0000003273'),
          url: './fireDetectionTab',
        }, // 화재탐지 및 경보설비 설치계획
        {
          title: this.$comm.getLangSpecInfoLabel('L0000003282'),
          url: 'diagramFile',
        }, // 화재탐지 및 경보설비 설치계획도
        {
    ...
    setAttachFile() {
      if (this.tabIndex === '1') {
        this.attachFileGrp = {
          taskClassNm: 'FIRE_DETECTION',
          taskKey: '0',
          diagClassCd: 'FIRED',
          taskFlag: 'SAF',
          plantCd: 'PLT01',
          label: 'L0000003282', // 화재탐지 및 경보설비 설치계획도
        };

        this.tap = this.attachFileGrp.diagClassCd;
      } else {
        this.attachFileGrp = {
          taskClassNm: 'FIRE_DETECTION_ATTACH',
          taskKey: 0,
          docuKindCd: 'FIRED',
          taskFlag: 'SAF',
          refTableId: '',
          label: 'L0000003275', // 화재탐지 및 경보설비 설치계획 문서
        };
