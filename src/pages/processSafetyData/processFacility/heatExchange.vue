    ...
    <b-row>
      <b-col sm="12">
        ...
        <y-auigrid
          ...
          :label="this.$comm.getLangSpecInfoLabel('L0000002008')"
...
export default {
  ...
  data() {
    return {
      ...
      YAuiGrid: null,
      gridOptions: {
        name: 'processSafetyDataHeatExchange',
        header: [],
        data: [],
        height: '300',
        tabs: true,
  ...
  methods: {
    init() {
      ...
      this.gridOptions.header = [
        ...
        { 
          headerText: this.$comm.getLangSpecInfoLabel('L0000002486'), 
          dataField: 'actLaw', 
          width: '200', 
          style: 'left-align', 
        }, // 적용법령 
    ...
    btnPopupClickedCallback(data) {
      ...
      this.popupOptions.title = 'L0000002005'; // 열교환기
