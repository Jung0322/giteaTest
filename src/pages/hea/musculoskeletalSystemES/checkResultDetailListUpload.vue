...
export default {
  ...
  name: 'check-result-detail-list-upload', // 반드시 입력하세요(안 하면 warning 발생). 네이밍 룰은 현재 vue component의 파일명의 단어를 "-"로 구분(예:exam-data)하여 입력하시면 됩니다. 입력후 이 주석은 지워주세요.
  props: {
    popupParam: {
      type: Object,
      default: {
  ...
  methods: {
    ...
    init() {
      // URL 셋팅
      this.searchExcelUrl = selectConfig.hea.muscResearch.excelUpload.url;
