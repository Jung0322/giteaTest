...
<template>
  <b-container fluid>
    <!-- <b-row>
      <b-col sm="12">
        <b-col sm="12" class="px-0" id="workMeasureResultChem">
    ...
    <b-row class="grid-height grid-box">
      <b-col sm="12" class="h100p">
        <y-auigrid
          ...
          :height="gridOptions.height"
          :label="this.$comm.getLangSpecInfoLabel('L0000004362')"
...
export default {
  ...
  watch: {
    ...
    'gridOptions.data': {
      handler: function () {
        this.$emit('getWorkMeasureChemResults', this.gridOptions.data);
      },
    },
  },
  ...
  methods: {
    ...
    cellEditEndHandler(event) {
      ...
      // this.checkData[event.rowIndex].exposureExcessFlag = 'O'
      this.$emit('getWorkMeasureChemResults', this.YAuiGrid.getGridData());
    },
