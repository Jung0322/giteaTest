  ...
  methods: {
    init() {
      ...
      this.gridOptions.header = [
        ...
        // 약품일련번호
        {
          headerText: this.$comm.getLangSpecInfoLabel('L0000001924'),
          dataField: 'ewtrChemCd',
          width: '13%',
          style: 'left-align',
        },
        // 단위
    ...
    btnPopupClickedCallback(data) {
      ...
      this.popupOptions.param = {
        ewtrChemNo: data ? data.ewtrChemNo : 0,
      };
    ...
    closePopup(data) {
      if (data === 'SAVE') {
        ...
        this.$emit('closePopup', data, 'chemBase');
      } else {
