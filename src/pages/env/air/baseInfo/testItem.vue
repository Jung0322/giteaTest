      ...
      <b-row slot="search">
        ...
        <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-3">
          <y-text
            ...
            label="L0000000319"
            name="eairTestItemNm"
            v-model="searchParam.eairTestItemNm"
          ></y-text>
        </b-col>
      </b-row>
    </y-search-box>
  ...
  methods: {
    init() {
      ...
      this.gridOptions.header = [
        ...
        // 대기총량제 사용여부
        {
          headerText: this.$comm.getLangSpecInfoLabel('L0000004836'),
