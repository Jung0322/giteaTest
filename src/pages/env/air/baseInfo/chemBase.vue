      ...
      <b-row slot="search">
        ...
        <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-3">
          <y-text
            ...
            label="L0000001922"
            name="eairChemNm"
            v-model="searchParam.eairChemNm"
          ></y-text>
        </b-col>
      </b-row>
    </y-search-box>
...
export default {
  ...
  methods: {
    init() {
      ...
      this.searchUrl = selectConfig.env.air.baseInfo.chemBase.list.url;
    ...
    btnPopupClickedCallback(data) {
      ...
      this.popupOptions.param = {
        eairChemCd: data ? data.eairChemCd : null,
      };
