...
export default {
  ...
  data: function() {
    return {
      ...
      searchUrl: '',
      useItems: [],
      eairPreventFacClassCdItems: [], // 방지시설분류
      YAuiGrid: null,
    };
  },
  watch: {},
  ...
  methods: {
    init() {
      ...
      // 방지시설분류
      this.$comm.getComboItems('EAIR_PREVENT_FAC_CLASS', true).then(_result => {
      ...
      this.gridOptions.header = [
        ...
        // 처리용량(㎡/min)
        {
          headerText: this.$comm.getLangSpecInfoLabel('L0000002837'),
          dataField: 'dispoCap',
          width: '150',
          style: 'left-align',
        },
        // 처리농도(mg/S㎥)
        {
          headerText: this.$comm.getLangSpecInfoLabel('L0000002819'),
          dataField: 'dispoConc',
          width: '150',
          style: 'left-align',
        },
