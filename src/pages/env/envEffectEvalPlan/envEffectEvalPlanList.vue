    ...
    <y-search-box :gridOptions="gridOptions" @enter="getList">
      <b-row slot="search">
        ...
        <b-col sm="4" md="4" lg="4" xl="4" class="col-xxl-6">
          ...
          <y-select
            :width="8"
            :comboItems="envEffEvalPlanStepCdItems"
            itemText="codeNm"
            itemValue="code"
            ui="bootstrap"
            label="L0000002777"
            name="envEffEvalPlanStepCd"
            v-model="searchParam.envEffEvalPlanStepCd"
          ></y-select>
        </b-col>
        <b-col sm="4" md="4" lg="4" xl="4" class="col-xxl-6">
          <!-- 진행상태 -->
...
export default {
  name: 'env-effect-eval-plan-list',
  props: {},
  data() {
    return {
      searchParam: {
  ...
  methods: {
    init() {
      ...
      this.gridOptions.header = [
        ...
        },
        {
          ...
          dataField: 'evalTitle',
          width: '200',
          style: 'center-center grid-link-cell',
        },
        {
          /* 대상부서 */
          headerText: this.$comm.getLangSpecInfoLabel('L0000000927'),
        ...
        },
        {
          ...
          dataField: 'envEffEvalPlanStepNm',
          width: '80',
          style: 'center-align',
        },
        {
      ...
      this.getComboItems('ENV_EFF_EVAL_PLAN_STEP_CD');
    ...
    getComboItems(codeGroupCd) {
      ...
      this.$http.request(
        (_result) => {
          if (codeGroupCd === 'ENV_EFF_EVAL_PLAN_STEP_CD') {
            this.envEffEvalPlanStepCdItems = this.$_.clone(_result.data);
            this.envEffEvalPlanStepCdItems.splice(0, 0, {
              code: '',
    ...
    tableLinkClicked(data) {
      ...
      if (data.dataField === 'apprStepNm') {
        ...
        this.popupOptions.param = {
          apprRqstNo:
            data.item.envEffEvalPlanStepCd === 'EEE01'
        ...
        if (data.item.envEffEvalPlanStepCd === 'EEE01') {
          this.popupOptions.title = 'L0000004897'; /* 환경영향평가 계획 */
          this.popupOptions.target = () =>
            import(`${'./envEffectEvalPlanDetail.vue'}`);
        } else {
          this.popupOptions.title = 'L0000004898'; /* 환경영향평가 결과 */
          this.popupOptions.target = () =>
            import(`${'./envEffectEvalRsltDetail.vue'}`);
          this.popupOptions.param.viewMode = true;
        }
