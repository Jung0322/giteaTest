    ...
    <b-row class="grid-height grid-box">
      <b-col sm="12" class="h100p">
        <y-auigrid
          ...
          :height="gridOptions.height"
          :label="this.$comm.getLangSpecInfoLabel('L0000003716')"
...
export default {
  ...
  methods: {
    ...
    cellClickHandler(event) {
      if (event.dataField !== 'safCheckKindNm') return;
      this.popupOptions.target = () => import(`${'./checkKindDetail.vue'}`);
      this.popupOptions.title = 'L0000003717'; // 점검종류 등록/수정
