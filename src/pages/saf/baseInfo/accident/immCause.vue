    ...
    <b-row>
      <b-col sm="12">
        ...
        <y-auigrid
          ...
          :label="this.$comm.getLangSpecInfoLabel('L0000002106')"
          :useExcelExport="true"
...
export default {
  ...
  data() {
    return {
      ...
      YAuiGrid: null,
      gridOptions: {
        name: 'safBaseInfoAccidentImmCause',
        header: [],
        data: [],
      },
      popupOptions: {
  ...
  methods: {
    init() {
      ...
      this.searchUrl = selectConfig.saf.accidentImmCause.list.url;
      ...
      this.gridOptions.header = [
        ...
        { 
          headerText: this.$comm.getLangSpecInfoLabel('L0000002105'), 
          dataField: 'codeNm', 
          width: '27%', 
          style: 'left-align', 
          renderer: {
    ...
    cellClickHandler(event) {
      ...
      this.popupOptions.target = () => import(`${'./immCauseDetail.vue'}`);
      this.popupOptions.title = 'L0000002104'; // 원인(직접) 상세 등록/수정
