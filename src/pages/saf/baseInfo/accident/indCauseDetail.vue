...
export default {
  ...
  methods: {
    init() {
      ...
      this.insertUrl = transactionConfig.saf.accidentIndCause.insert.url;
      this.editUrl = transactionConfig.saf.accidentIndCause.edit.url;
      this.searchUrl = selectConfig.saf.accidentIndCause.list.url;
      this.detailUrl = selectConfig.saf.accidentIndCause.get.url;
      this.checkUrl = selectConfig.saf.accidentIndCause.check.url;
              ...
              (_result) => {
                ...
                if (_result.data && _result.data.length > 0) {
                  if (
                    ...
                    window.getApp.$emit('ALERT', {
                      title: 'L0000003395', // 안내
                      message: 'M0000000695', // 이미 같은 원인(간접)명이 존재합니다.
                      type: 'warning',
                    });
                    result = false;
                  }
