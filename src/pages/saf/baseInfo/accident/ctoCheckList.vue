    ...
    <b-row>
      <b-col sm="12">
         ...
         <y-auigrid
          ...
          :label="this.$comm.getLangSpecInfoLabel('L0000002855')"
          :useExcelExport="true"
...
export default {
  ...
  data() {
    return {
      ...
      YAuiGrid: null,
      gridOptions: {
        name: 'safBaseInfoAccidentCtoCheckList',
        header: [],
        data: [],
      },
      popupOptions: {
  ...
  methods: {
    init() {
      ...
      this.searchUrl = selectConfig.saf.cto.checkList.url;
    ...
    cellClickHandler(event) {
      ...
      this.popupOptions.target = () => import(`${'./ctoCheckListDetail.vue'}`);
      this.popupOptions.title = 'L0000003435'; // 체크리스트 상세
