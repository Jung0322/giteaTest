      ...
      <b-col sm="12">
        ...
        <b-col sm="12" class="h100p">
          <y-auigrid
            ...
            :height="gridOptions.height"
            :label="this.$comm.getLangSpecInfoLabel('L0000001432')"
...
export default {
  ...
  name: 'check-result-performance-establishment',
  props: {},
  data() {
    return {
      searchParam: {
      ...
      gridOptions: {
        name: 'checkResultPerformanceEstablishment',
        header: [],
        data: [],
        height: 'auto',
      },
  ...
  watch: {
    'searchParam.plantCd'() {
      this.searchPlantCd = this.searchParam.plantCd;
    },
  },
  ...
  methods: {
    init() {
      ...
      // Url Setting
      this.searchUrl = selectConfig.saf.checkResult.status.url;
    ...
    cellClickHandler(event) {
      ...
      this.popupOptions.title = 'L0000001870'; // 안전점검
