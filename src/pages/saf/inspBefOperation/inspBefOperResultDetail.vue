          ...
          <b-col sm="12">
            ...
            <div slot="buttonGroup" class="float-right mb-1">
              ...
              <y-btn
                v-if="
                  isSave &&
                  preOperChkResult.rBizApprStepCd !== 'BAPSD' &&
                  !popupParam.apprFlag &&
              ...
              <!-- 삭제 -->
              <y-btn
                v-if="isSave && !popupParam.apprFlag"
                color="red"
                title="L0000001495"
          ...
          <b-row>
            <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-3">
              <y-plant
                ...
                :editable="editable"
                :required="true"
                :disabled="isComplete || popupParam.popupMode"
                name="plantCd"
    ...
    >
      ...
      <keep-alive>
        <component
          ...
          :noPlanYn="preOperChkResult.noPlanYn"
          :inspBefChkPlan="preOperChkResult"
          :disabled="isComplete"
          :tabIndex.sync="count"
          sm="12"
...
export default {
  ...
  data: () => ({
    ...
    tabItems: [
      // { title: 'L0000000405', url: './inspBefOperResultInfo.vue' }, // 결과
  ...
  methods: {
    init() {
      ...
      console.log('1111', this.popupParam.popupMode);
    },
    loadComponent() {
    ...
    getDetail() {
      ...
      this.$http.request(
        (_result) => {
          ...
          this.tabItems = [
            { title: 'L0000000405', url: './inspBefOperResultInfo.vue' }, // 결과
            { title: 'L0000002572', url: './inspBefOperInspector.vue' }, // 점검자
            { title: 'L0000000259', url: 'imprActTab' }, // 개선사항
            { title: 'L0000002843', url: 'fileUploadPage' }, // 첨부파일
          ];
        ...
        .then((_result) => {
          if (_result) {
            window.getApp.$emit('CONFIRM', {
              ...
              // 확인 callback 함수
              confirmCallback: () => {
                this.preOperChkResult.chkStepCd = 'CHS02';
      ...
      if (returnVal) {
        window.getApp.$emit('CONFIRM', {
          ...
          confirmCallback: () => {
            ...
            this.$http.type = 'PUT';
            this.$http.param = this.preOperChkResult;
            this.$http.request(
              (_result) => {
