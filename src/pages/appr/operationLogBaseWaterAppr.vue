...
export default {
  ...
  methods: {
    ...
    loadComponent() {
      this.comDischRunTm = () =>
        import(`${'@/pages/env/water/operationLog/dischRunTm.vue'}`);
      this.comPreventRunTm = () =>
        import(`${'@/pages/env/water/operationLog/preventRunTm.vue'}`);
      this.comSuplChkResult = () =>
        import(`${'@/pages/env/water/operationLog/suplChkResult.vue'}`);
      this.comDischChkResult = () =>
        import(`${'@/pages/env/water/operationLog/dischChkResult.vue'}`);
      this.comPwrcChkResult = () =>
        import(`${'@/pages/env/water/operationLog/pwrcChkResult.vue'}`);
      this.comIngrChkResult = () =>
        import(`${'@/pages/env/water/operationLog/ingrChkResult.vue'}`);
      this.comChemChkResult = () =>
        import(`${'@/pages/env/water/operationLog/chemChkResult.vue'}`);
      this.comPreventBreakHist = () =>
        import(`${'@/pages/env/water/operationLog/preventBreakHist.vue'}`);
      this.comSludgeProcess = () =>
        import(`${'@/pages/env/water/operationLog/sludgeProcess.vue'}`);
      this.inspection = () =>
        import(`${'@/pages/env/water/operationLog/inspection.vue'}`);
      this.comTestItemResult = () =>
        import(`${'@/pages/env/water/operationLog/testItemResult.vue'}`);
    },
    getDetail() {
    ...
    getCleanItems() {
      ...
      this.$http.type = 'GET';
      this.$http.param = { plantCd: this.ewtrOpLogResult.plantCd };
      this.$http.request(
        _result => {
          _result.data.splice(0, 0, {
            ewtrCleanFacNo: null,
            ewtrCleanFacNm: '선택하세요',
          });
