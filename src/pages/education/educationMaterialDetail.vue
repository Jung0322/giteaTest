...
export default {
  ...
  watch: {
    ...
    'eduMaterial.eduTypeCd': function (newValue, oldValue) {
      this.getEduCourseItems();
    },
    'eduMaterial.plantCd': function (newValue, oldValue) {
      this.getEduCourseItems();
    },
  },
  beforeMount() {
  ...
  methods: {
    ...
    init() {
      ...
      if (this.popupParam.eduMatNo === 0) {
        ...
        this.eduMaterial.plantCd = this.$store.getters.plantCd;
    ...
    getEduCourseItems() {
      ...
      this.$http.param = {
        ...
        eduTypeCd: this.eduMaterial.eduTypeCd,
        plantCd: this.eduMaterial.plantCd,
      };
      this.$http.request(
        (_result) => {
