...
export default {
  ...
  methods: {
    init() {
      ...
      this.searchParam.completCheckYn = this.popupParam.completCheckYn;
      this.searchParam.notReEduYn = this.popupParam.notReEduYn;

      // Url Setting
      this.searchUrl = selectConfig.saf.education.eduUserList.list.url;
