          ...
          <b-row>
            ...
            <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-6">
              ...
              <y-tree-dept
                ...
                label="L0000001287"
                name="deptCd"
                :disabled="isDisabledDeptCd"
                :plantCd="noAccident.plantCd"
                v-model="noAccident.deptCd"
                :required="true"
                v-validate="'required'"
                :state="validateState('deptCd')"
                @setDeptNm="onChangeDeptCd"
              />
            </b-col>
            <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-6">
              <!-- 무재해시작일 -->
            ...
            <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-6">
              <!-- 목표일수 수정 전 : :disabled="isInActiveYn"-->
              <y-number
                :width="baseWidth"
                ui="bootstrap"
                :disabled="true"
            ...
            <b-col sm="6" md="6" lg="6" xl="6" class="col-xxl-6">
              <!-- 목표달성예정일 수정 전 : :disabled="updateMode" -->
              <y-datepicker
                :width="baseWidth"
                :editable="editable"
                :disabled="true"
...
export default {
  ...
  watch: {
    ...
    'noAccident.startYmd': function (newValue, oldValue) {
      if (this.isInit === false) {
        ...
        // let tDay = Math.floor(
        //   Number(this.noAccident.multiple) *
        //     Number(this.noAccident.stndDays) *
        //     1.14
        // );
  ...
  methods: {
    ...
    init() {
      // URL 셋팅
      this.insertUrl = transactionConfig.saf.deptNoAccidentResult.insert.url;
      this.editUrl = transactionConfig.saf.deptNoAccidentResult.edit.url;
      this.searchUrl = selectConfig.saf.deptNoAccidentResult.list.url;
      this.checkUrl = selectConfig.saf.deptNoAccidentResult.check.url; // 부서 무재해 중복 체크
      this.deleteUrl = transactionConfig.saf.deptNoAccidentResult.delete.url;

      // 수정 또는 신규등록 버튼 Mode
      this.noAccident.safNoAccidentDeptNo = this.popupParam.safNoAccidentDeptNo;
      ...
      // 수정
      if (this.popupParam.safNoAccidentDeptNo !== 0) {
        this.isDisabledPlantCd = true;
        this.isDisabledDeptCd = true;
        this.getNoAccident();
        ...
        this.noAccident.deptCd = this.$store.getters.deptCd; // 부서코드
    ...
    getNoAccident() {
      this.$http.url = this.$format(
        selectConfig.saf.deptNoAccidentResult.get.url,
        this.noAccident.safNoAccidentDeptNo
      );
      this.$http.type = 'GET';
      this.$http.request(
        (_result) => {
    ...
    getNoAccidentList() {
      ...
      this.searchParam.deptCd = this.noAccident.deptCd;
        ...
        .then((_result) => {
          ...
          if (_result) {
            ...
            this.$http.param = {
              ...
              deptCd: this.noAccident.deptCd,
              // dtlDeptNm: this.noAccident.dtlDeptNm,
            };
            this.$http.request(
              (_result) => {
                if (_result.data > 0) {
                  window.getApp.$emit('ALERT', {
                    ...
                    message: 'M0000000605', // 이미 같은 부서 무재해 정보가 존재합니다.
                    type: 'warning',
                  });
                } else {
            ...
            if (!this.noAccident.deptCd) {
              window.getApp.$emit('ALERT', {
                title: 'L0000003395' /* 안내 */,
                message: 'M0000000455', // 부서를 선택하세요.
                type: 'warning', // success / info / warning / error
              });
              return;
            }
    ...
    btnInsertClickedCallback(_result) {
      this.noAccident.safNoAccidentDeptNo = _result.data;
      this.isInsertSubmit = false;
      window.getApp.$emit('ALERT', {
        title: 'L0000003395' /* 안내 */,
    ...
    btnDeleteClicked() {
      window.getApp.$emit('CONFIRM', {
        ...
        confirmCallback: () => {
          ...
          this.$http.type = 'PUT';
          this.$http.param = {
            safNoAccidentDeptNo: this.noAccident.safNoAccidentDeptNo,
