...
export default {
  ...
  methods: {
    ...
    openNewPopup() {
      this.popupOptions.target = () => import(`${'./mgtTargetPlan.vue'}`);
      this.popupOptions.title = 'L0000004967'; /* 목표 등록및수정 */
    ...
    cellClickHandler(event) {
      if (event.dataField === 'stepNm') {
        ...
        this.popupOptions.top = '10px';
        this.popupOptions.param = {
          mgtTargetGrpNo: event.item.mgtTargetGrpNo,
          areaType: this.searchParam.areaType,
        };
        this.popupOptions.closeCallback = this.closePopup;
      }
    ...
    tableLinkClicked(header, data) {
      if (header.name === 'stepNm') {
        ...
        this.popupOptions.top = '10px';
        this.popupOptions.param = {
          mgtTargetGrpNo: data.mgtTargetGrpNo,
          areaType: this.searchParam.areaType,
        };
        this.popupOptions.closeCallback = this.closePopup;
      }
    ...
    btnRsltAppr() {
      ...
      let data = this.gridOptions.data.filter(
