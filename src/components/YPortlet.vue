        ...
        >
          <el-popover placement="left" width="180" trigger="click">
            <el-table
              ...
              :show-header="false"
            >
              <el-table-column width="70" property="codeNm"></el-table-column>
              <!-- 백그라운드 때문에 빈 프로퍼티 일부러 호출 -->
              <el-table-column width="70" property="remarks"></el-table-column>
            </el-table>
            <el-button slot="reference">범례</el-button>
          </el-popover>
        </span>
        <span v-if="url">
          <el-button
...
.portlet-board {
  ...
  box-shadow: 0 3px 3px rgba(82, 63, 105, 0.04);
  padding: 0;
  background: #fff;
  border-radius: 5px;
  position: relative;
...
.portlet-wrap .list-info-wrap ul,
...
.portlet-green .text-style2 > div,
.portlet-green .text-style2 > span {
  color: #fff;
}
...
.chart-box.horizontal .chart-line::before,
.chart-box.horizontal .chart-line::after {
  display: none;
}
